...
```bash
git clone https://github.com/toscani-tenekeu/wFileManager_Website.git
cd wFileManager_Website
npm install
npm run dev
```
...
- [wFileManager project](https://github.com/toscani-tenekeu/wFileManager)
